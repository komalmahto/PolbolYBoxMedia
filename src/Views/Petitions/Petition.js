...
function Petition() {
  const history=useHistory();
    ...
    const categories=['Animals','Animals','Animals','Animals','Animals','Animals','Animals','Animals'];
  ...
  return (
    <div>
      ...
      <div className={styles.body}>
          <p className={styles.ques}>What kind of issue are you petitioning on?</p>
          <p className={styles.qtext}>Selecting a topic allows Change.org to recommend your petition to interested supporters.</p>
      </div>
      ...
      <div className={styles.cards}>
        {categories.map((value,key)=>
          ...
          <div key={key} id={value}  className={styles.card}>
                <div id={value} onClick={handleSelect} className={styles.tile}>
                </div>
                <p id={value} onClick={handleSelect}>{value}</p>
            </div>
            ))}
      </div>
