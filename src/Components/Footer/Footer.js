        ...
        <div style={{
            ...
            <Row style={{ color: "white" }}>
                ...
                <Col xs={24} sm={24} md={14} style={{ padding: "10px" }}>
                    ...
                    <p style={{ marginTop: "20px", fontSize: "12px", color: 'white', width: '230px' }}>Copyright © 2021 All rights reserved | This template is made by <a style={{ color: 'white', textTransform: 'none' }} href='http://www.yboxmedia.com/' target="_blank">YBox Technologies</a></p>
                    <div>
                        <br />
